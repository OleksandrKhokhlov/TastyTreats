function doNumberRounding(rating) {
  const tenthOfRating = (rating.toFixed(1)-Number.parseInt(rating.toFixed(1))).toFixed(1);
  console.log(tenthOfRating);
      ...
      <div class="recipe-info">
        ...
        <div class="recipe-rating-and-btn-wrapper">
          <div class="recipe-rating-wrapper">
            <span class="recipe-rating-number">${doNumberRounding(recipe.rating)}</span>
